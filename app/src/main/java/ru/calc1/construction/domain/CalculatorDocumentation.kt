package ru.calc1.construction.domain
 ...
 *
 * All calculators are defined in [CalculatorRepository] and calculated by [ru.calc1.construction.domain.engine.CalculatorEngine].
 *
